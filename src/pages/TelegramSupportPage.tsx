...
const sections: InfoPageSection[] = [
  {
    ...
    paragraphs: [
      'Это самый быстрый способ получить ответ от команды KURS. Мы подключаем инженеров, менеджеров и финконтроль в одном чате.',
    ],
    list: [
  ...
  {
    title: 'Как начать',
    paragraphs: ['Напишите нам в @kurs_support или перейдите по ссылке t.me/kurs_support.'],
    list: [
