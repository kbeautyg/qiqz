...
const sections: InfoPageSection[] = [
  {
    title: 'О компании',
    paragraphs: [
      'KURS — финтех-команда с опытом построения платёжных решений в России и СНГ. Мы помогаем бизнесу принимать платежи в рублях и конвертировать их в стабильные цифровые активы.',
    ],
  },
  {
    title: 'Наши принципы',
  ...
  },
  {
    ...
    paragraphs: [
      '© 2026 KURS. Все права защищены. Мы регулярно обновляем юридические документы и уведомляем клиентов об изменениях заранее.',
    ],
  },
]
...
const AboutPage: React.FC = () => (
  <InfoPageTemplate
    badge="О компании"
    title="KURS — прозрачный сервис для приёма платежей"
